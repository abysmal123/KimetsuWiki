...
public class TabFragment1 extends Fragment {
    ...
    public TabFragment1(ArrayList<Character> characterList) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.view =  inflater.inflate(R.layout.tab_fragment1, container, false);
        initRecyclerView();
        return this.view;
    }

    private void initRecyclerView() {
        this.mRecyclerView = (RecyclerView)this.view.findViewById(R.id.good_characters);
